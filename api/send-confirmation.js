...
<body style="margin: 0; padding: 0; font-family: Georgia, 'Palatino Linotype', Palatino, 'Book Antiqua', serif; background-color: #f9fafb;">
    ...
    <tr>
      <td align="center" style="padding: 40px 20px;">
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width: 600px; background-color: #ffffff; border-radius: 8px; border: 1px solid #e5e7eb;">
          ...
          <!-- Header -->
          <tr>
            <td style="background-color: #FDE7EE; padding: 24px 32px; border-radius: 8px 8px 0 0; text-align: center;">
              <p style="margin: 0; color: #000000; font-size: 20px; font-weight: 700; letter-spacing: 0.5px;">Chuck's Bakes</p>
            </td>
          </tr>
